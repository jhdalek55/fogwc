...
assumed in the literature) could set up their own instances of
all components, and then federate using Seattle's open interfaces
(as desired by Belli et al.~\cite{belli_design_2015})
...
end users; with the Experimenters as over-the-top service or
software providers.
