...
Thus, device owners can choose which experimenters to grant
...
\subsection{Roles, or perhaps: Deployment Options?}
...
\albert{Alternatively: Let's talk about different deployments, and what roles get assigned to whom.}
