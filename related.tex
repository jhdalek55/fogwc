...
\lukas{AFAIU, they use explain(?) docker commands and claim that it is great for fog because the images are small (agility) and because data is non-persistent (low storage footprint) - not very helpful}
